      ...
      def process(payload)
        ...
        deposit.with_lock do
          ...
          unless wallet
            ...
            ::AMQP::Queue.enqueue(:deposit_collection, id: deposit.id)
            return
          end

          transactions = WalletService.new(wallet, deposit.currency_id).deposit_collection_fees!(deposit, deposit.spread_to_transactions)
